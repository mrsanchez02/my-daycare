...
export function PostComposerCard({ teacher }: PostComposerCardProps) {
  return (
    <button
      type="button"
      className="mb-6 flex w-full items-center gap-[14px] rounded-[18px] border border-[#ece0d0] bg-[#fffdf9] px-4 py-[14px] text-left shadow-[0_4px_14px_-10px_rgba(120,90,60,0.4)] sm:px-[18px]"
    >
      ...
      <span className="flex size-9 items-center justify-center rounded-xl bg-[#fbe3d8] text-[#e0654a] sm:size-[38px]">
